...
namespace Grc\Corporatetraining\Preferences;
...
class Main extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            'alt_img',
            'text',
            ['name' => 'alt_img', 'label' => __('Alt Img'), 'title' => __('Alt Img'), 'required' => false]
        );
        ...
        $fieldset->addField(
            'is_featured',
            'select',
            ['name' => 'brand[is_featured]', 'label' => __('Featured Brand'), 'title' => __('Featured Speaker'), 'options' => $this->_yesno->toOptionArray()]
        );
        $fieldset->addField(
            'sort_order',
            'text',
