<?php
namespace Vivek\KnockOut\Block\Customer\Form;

use Magento\Backend\Block\Template\Context;
use Magento\Framework\Registry;
use Magento\Framework\Data\FormFactory;
use Vivek\KnockOut\Block\Widget\Form\Renderer\Element;
use Vivek\KnockOut\Block\Widget\Form\Renderer\Fieldset;
        ...
        foreach ($attributes as $attribute) {
            ...
            if ($inputType = $attribute->getFrontend()->getInputType()) {
                ...
                if ($inputType == "boolean") {
                    $fieldType = 'Webkul\Blogs\Block\Data\Form\Element\\' . ucfirst($inputType);
                } else {
